...
public class MyMain {
	...
	public static void main(String[] args) {
		//Objective: Test the communication between conductor and
		//			 the music groups watching him/her
		
		//TASK 1: CREATE THE TROMBONE, TRUMPET, AND TUBA GROUPS
		...
		//TEST 4: TEST THE NOTIFICATION UPDATE
